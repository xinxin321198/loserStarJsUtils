...
var DeptSelectTree = function (buttonSelector, treeGridSelector, url, treeGridReadyCallback, selectType, selectedEventCallBck) {
    ...
    this.url = url;
    // this.init = DeptSelectTree.init;//初始化组件以及数据
    // this.getSelectedDeptStrs = DeptSelectTree.getSelectedDeptStrs;//获取已选中的项,以字符串分割的形式返回
    // this.setSelectedDeptStrs = DeptSelectTree.setSelectedDeptStrs;//设置哪些项选中，参数以字符串分割的形式传入
